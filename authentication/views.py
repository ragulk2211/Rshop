...
def verify_otp(request):
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            if otp_record.is_expired():
                ...
                # OTP is valid -> redirect to password rest form with user info in session
    ...
    return render(request, 
                  'authentication/pwd_reset/verify_otp.html',
                  context)

# setting new password taking the verify email from session
...
def set_new_password(request):
    ...
    return render(request,'authentication/pwd_reset/set_new_password.html', context )